  ...
  function confirmCode() {
    ...
    if (userID && code) {
      ...
      fetch(url, request)
        ...
        .then((data) => {
          if (data) {
            curUser?.is_teacher ? router.push('/coach/dashboard') : router.push('/general/lessons');
          } else {
    ...
    <>
      <div className="my-44 flex w-full items-center justify-center">
        <Paper className="m-4 px-6 py-10">
          <h1 className="mb-6 text-center text-3xl font-bold text-primary-800">Mentorey</h1>
